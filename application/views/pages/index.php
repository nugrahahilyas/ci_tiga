            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="mx-auto"></div>
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item proyekhilyas">
...
<section class="pt-5 mt-5" id="home" data-nav="home">
    ...
    <!-- pengenalan -->
    <section class="bgstel2 pt-5" id="pengenalan" data-nav="pengenalan">
    <div class="container">
 ...
 <section class="pt-5 pb-5" id="kompetensi" data-nav="kompetensi">  
    <div class="container">
...
<script src="<?= base_url('assets/'); ?>vendor/jquery/jquery.min.js"></script>
    ...
    $(document).ready(function () {
        $('nav a.nav-link').on('click', function (event) {
            ...
            if ($(this).closest('li').hasClass('proyekhilyas')) {
